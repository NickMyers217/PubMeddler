...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { journal: @query.journal, maxdate: @query.maxdate, mindate: @query.mindate, retmax: @query.retmax, term: @query.term }
    end
  ...
  test "should update query" do
    patch :update, id: @query, query: { journal: @query.journal, maxdate: @query.maxdate, mindate: @query.mindate, retmax: @query.retmax, term: @query.term }
    assert_redirected_to query_path(assigns(:query))
  end
